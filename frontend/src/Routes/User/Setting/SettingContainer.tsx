...
import EditProfilePresenter from "./SettingPresenter";
...
import { EDIT_PROFILE, DELETE_PROFILE } from "./SettingQueries";
...
class SettingContainer extends React.Component<IProps, IState> {
