        ...
        if payload == "PHOTO":
            if targetLocationType == "city":
                ...
                attachments = [{
                    ...
                    "title_link": "https://pinner-fun.herokuapp.com/city/%s" % (city.city_id),
                ...
                attachments = [{
                    ...
                    "title_link": "https://pinner-fun.herokuapp.com/country/%s" % (country.country_code),
                ...
                attachments = [{
                    ...
                    "title_link": "https://pinner-fun.herokuapp.com/continent/%s" % (continent.continent_code),
